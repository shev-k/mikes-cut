-- Quick Setup Script for Product Management
-- Copy and paste this entire script into Supabase SQL Editor

-- Step 1: Verify categories exist
SELECT * FROM categories;

-- If categories table is empty or missing the required categories, run:
...
-- Step 3: Insert all existing products (if needed)
-- This uses conditional inserts to avoid duplicates
...
-- You should see all 12 products with their categories!
